    ...
    <section className="container text-primary">
      <div className="row align-items-end mb-5">
        ...
        <div className="col-lg-7">
          ...
          <div className="video-container mb-4 mb-lg-0 ratio ratio-16x9">
        ...
        <div className="col-lg-5">
          <div className="card bg-secondary text-white">
            <div className="card-body">
              <h4 className="ftext  text-primary">¡Sé uno más del movimiento!</h4>
              ...
              <div className="d-flex">
                ...
                <p className="w-50 text-white">Cobramos sólo <br />gastos de producción</p>
              </div>
        ...
        <div className="col">
          <ol className="custom">
            <li className="mb-4">
              ...
              <p>Necesitamos que se implique el mayor número de vecinos posible.</p>
              <p>Tú puedes ayudarnos, simplemente coméntaselo a amigos y conocidos.</p>
            </li>

            <li className="mb-4">
              <h5>¡Síguenos en redes sociales y únete a nuestras acciones!</h5>
              <p>Puedes seguirnos en <a href="https://www.instagram.com/bellavistapacuando/" target="_blank">instagram</a>, <a href="https://www.facebook.com/profile.php?id=100086093963788" target="_blank">facebook</a> y <a href="https://twitter.com/Bellav_PaCuando" target="_blank">twitter</a>.</p><p>Allí podras seguir nuestras acciones y unirte a ellas para lograr una Bellavista digna.</p>
            </li>

            <li className="mb-4">
              <h5>Usa el “hashtag” #BellavistaPaCuando” en redes sociales</h5>
              <p>Comparte en redes sociales tus quejas sobre el estado del barrio.</p><p>Si usas el hashtag #BellavistaPaCuando y etiquetas al ayuntamiento o a los responsables del gobierno, mejor.</p>
            </li>
          </ol>
        </div>
      </div>
